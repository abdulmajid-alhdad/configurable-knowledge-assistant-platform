import { SYSTEM_CONTROL_PAGES } from "/assets/system/controls-pages.js?v=stage4-provider-catalogue-safety-1";
import { SYSTEM_PAGES } from "/assets/system/pages.js?v=stage4-provider-catalogue-safety-1";
